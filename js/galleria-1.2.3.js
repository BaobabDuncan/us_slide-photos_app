...
var Galleria = function() {
    ...
    // add some elements
    var divs =  'container stage images unfavorites unfavorites-form image-nav image-nav-left image-nav-right ' +
    ...
    var lightbox = this._lightbox = {
        ...
        init : function() {
            ...
            var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image message date unfavorit_btn',
                el = {},
                op = self._options,
                css = '',
            ...
            $.each({
                    ...
                    info: 'title counter message date unfavorit_btn',
                    content: 'info image',
                    prevholder: 'prev',
                    nextholder: 'next'
                }, function( key, val ) {
        ...
        show: function(index) {
            ...
            lightbox.image.load( data.image, function( image ) {
                ...
                //console.info(data);
                lightbox.elems.unfavorit_btn.innerHTML = self.unfavoritBtnHtml(data);
                lightbox.elems.message.innerHTML = '|'+self.slideMessage(data.description);
                lightbox.elems.date.innerHTML = '|'+data.created;
    ...
    _init: function() {
        ...
        this.append({
            ...
            'unfavorites' :
                ['unfavorites-form'],
            'stage' :
                ['images', 'loader', 'counter', 'image-nav', 'unfavorites'],
            'thumbnails-list' :
                ['thumbnails'],
...
this.prependChild( 'info', 'myElement' );
    ...
    */
    ...
    setInfo : function( index ) {
        ...
        $.each( ['title','description'], function( i, type ) {
            ...
            if ( !!data[type] ) {
            	var html = data[ type ];
            	if (type == 'title') html = data[ type ] + ' | <span>'+ data[ 'created' ]+'</sapn>';
    ...
    */
    ...
    unfavoritBtnHtml : function(data){    	
    	var html ='';    	
    	html += "<form>";
    	html += "<input type='hidden' name='favorites_key' id='favorites_key' value='"+data.favorites_key+"'>";    	
    	html += "<input type='submit' style='font-size: 8px; margin-top: -2px;' value='Un Favorites'>";
    	html += "</form>";
    	return html;    	
    },
